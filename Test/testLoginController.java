...
public class testLoginController {
 ...
 public void setUp() throws Exception {
  ...
  this.accountController.createAccount("userfirst1", "userlast", "userun1", "userpw","u", "Y");
 ...
 public void testVerifyUserCase1() {
  ...
  boolean test = loginController.verifyUser("userun1", "userpw").equals("u");
  assertTrue(test);
  this.accountController.deactivateAccount("userfirst1");
