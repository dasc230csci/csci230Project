...
public class AccountDBControllerTest {
  ...
  */
  ...
  public void testDeleteUser() {
   ...
   assertTrue("the user in the list is" + list.get(0).getFirstName(),list.get(0).getUsername().equals("anhtran"));
   assertTrue("the user in the list is" + list.get(1).getFirstName(),list.get(1).getUsername().equals("caitlinharvey"));
   assertTrue("the user in the list is" + list.get(2).getFirstName(),list.get(2).getUsername().equals("juser"));
   assertTrue("the user in the list is" + list.get(3).getFirstName(),list.get(3).getUsername().equals("luser"));
   assertTrue("the user in the list is" + list.get(4).getFirstName(),list.get(4).getUsername().equals("nadmin"));
   assertTrue("the user in the list is" + list.get(5).getFirstName(),list.get(5).getUsername().equals("Sammy"));
   assertTrue("the user in the list is" + list.get(6).getFirstName(),list.get(6).getUsername().equals("useru"));
   //assertTrue("the user in the list is" + list.get(7).getFirstName(),list.get(7).getUsername().equals("userun"));
