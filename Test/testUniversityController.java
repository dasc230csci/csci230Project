...
public class testUniversityController {
	...
	public void testCreateUniversityCase1(){
		...
		schoolInfo.add(0, "TESTING-UNIVERSITY");
		...
		assertTrue(this.universityController.createUniversity(schoolInfo));
		this.universitydbController.deleteUniversity("TESTINGUNIVERSITY1");
	...
	public void testCreateUniversityCase2(){
		...
		this.universityController.createUniversity(schoolInfo);
