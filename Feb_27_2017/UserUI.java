 ...
 * 
 * @author Caitlin Harvey, Anh Tran, Sam Halloran, Daniel Song
 */

public class UserUI {

 //no current instance variables
  ...
  /**
   * the editProfile() method, needs further clarifiction
   * on its exact uses 
   * @return boolean t/f
   */
  ...
  //       ?????
  public ArrayList resetUserInfo(){
   ...
   * @return ArrayList
   */
  public ArrayList viewUniversityInDetail(){
   ...
   * the search creteria fields are cleared to become ready to 
